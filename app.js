      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: techs.map((t, i) => ({
            label: t.short,
            data: catKeys.map(c => techCategoryAvg(t, c)),
            borderColor: t.color,
        ...
        options: {
          ...
          scales: {
            r: {
              min: 0, max: 5,
              ticks: { stepSize: 1, font: { size: 10, family: "'JetBrains Mono'" }, backdropColor: 'transparent' },
              grid: { color: '#E5E3DE' },
              angleLines: { color: '#E5E3DE' },
              pointLabels: { font: { size: 10, family: "'DM Sans'" }, color: '#6B6B6B' }
            }
          },
          plugins: {
            legend: { position: 'bottom', labels: { font: { size: 12, family: "'DM Sans'" }, usePointStyle: true, padding: 16 } }
          }
        }
      });
    }
